 ...
 */
	class TF_PostSlider extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Post Silder', 'fusion-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fusion_iconbox textblock_element textblock_element_style" id="fusion_post_silder">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fusion_iconbox_icon"><i class="fusiona-layers-alt"></i><sub class="sub">'.__('Post Silder', 'fusion-core').'</sub><p>layout = <span class="post_slider_layout">posts-with-excerpts</span><br /><span class="cat_container" style="selector:attrib"> category = <span class="post_slider_cat">design</span></span></p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$wp_categories 	= Helper::get_wp_categories_list();
