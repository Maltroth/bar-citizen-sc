 ...
 */
	class TF_ContentBoxes extends DDElementTemplate {
	  ...
	  $am_array[] = array ( 
						  ...
						  array( "name"	 => __('Read More Link Url', 'fusion-core'),
										"desc"		=> __('Add the link\'s url ex: http://example.com', 'fusion-core'),
										"id"		=> "fusion_link[0]",
										"type"		=> ElementTypeEnum::INPUT,
										"value"	   => array() 
							),
						  array( "name"	 => __('Read More Link Text', 'fusion-core'),
										"desc"		=> __('Insert the text to display as the link', 'fusion-core'),
										"id"		=> "fusion_linktext[0]",
										"type"		=> ElementTypeEnum::INPUT,
										"value"	   => array() 
							),
						  array("name"	=> __('Read More Link Target', 'fusion-core'),
			...
			$this->config['subElements'] = array(
				array("name" 			=> __('Box Layout', 'fusion-core'),
					  "desc" 			=> __('Select the layout for the content box', 'fusion-core'),
					  "id" 				=> "fusion_layout",
					  "type" 			=> ElementTypeEnum::SELECT,
					  "value" 			=> "icon-with-title",
					  "allowedValues" 	=> array('icon-with-title' 			=> __('Icon beside Title', 'fusion-core'),
				...
				array("name"			=> __('Icon Circle Size', 'fusion-core'),
					  "desc"			=> __('Choose the size of the icon and circle.', 'fusion-core'),
					  "id"				=> "fusion_circle_size",
					  "type"			=> ElementTypeEnum::SELECT,
					  "value"	   		=> array("small"),
					  "allowedValues"   => array('small'	=>'Small',
												 'medium'	=>'Medium',
												 'large' 	=> 'Large') 
						),
