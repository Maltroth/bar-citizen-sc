...
<div id="fusion-page-builder" class="fusion-page-builder-hide" instance="<?php echo get_the_ID();?>">
	<h1 class="section_heading fusion_toggler">
		<?php _e('Fusion Builder', 'fusion-core'); ?> 
		<i class="fa fa-sort-desc fusion-toggler"></i>
	...
	<div class="fusion_insider">
		...
		<div id="ddbuilder">
			...
			<div class="width_flex" style="padding:0; width:100.2%; padding:0 0 20px 0; border-bottom:none; margin-top:-30px;" id="paletteContainer">
