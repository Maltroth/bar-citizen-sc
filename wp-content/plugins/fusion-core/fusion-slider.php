			...
			if( ! $smof_data['status_fusion_slider'] ) {
				register_post_type(
					...
					array(
						...
						'hierarchical' => false,
						'labels' => array(
							'name'				=> _x( 'Fusion Sliders', 'Post Type General Name', 'fusion-core' ),
							'singular_name'	   => _x( 'Fusion Slider', 'Post Type Singular Name', 'fusion-core' ),
				...
				register_taxonomy('slide-page', 'slide',
					array(
						...
						'show_tagcloud' => false,
						'labels' => array(
							'name'					   => __( 'Sliders', 'fusion-core' ),
							'singular_name'			  => __( 'Slider', 'fusion-core' ),
