...
class FusionSC_OneFourth {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'one-fourth-shortcode' ), FusionCore_Plugin::attributes( 'one-fourth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-one-fourth one_fourth fusion-layout-column fusion-column';
