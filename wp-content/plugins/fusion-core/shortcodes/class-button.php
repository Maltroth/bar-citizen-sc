...
class FusionSC_Button {
	...
	function render( $args, $content = '') {
		...
		if( $defaults['shadow'] === '0' ) {
			$defaults['shadow'] = 'yes';
		} else if( $defaults['shadow'] === '1' ) {
			$defaults['shadow'] = 'no';
		}
		...
		if( ( $color == 'custom' || $color == 'default' ) && 
			...
			if( $general_styles ) {
				$styles .= sprintf( '#wrapper .fusion-button.button-%s{%s}', $this->button_counter, $general_styles );
			}
			
			if( $button_3d_styles ) {
				$styles .= sprintf( '#wrapper .fusion-button.button-%s.button-3d{%s}.button-%1$s.button-3d:active{%2$s}', $this->button_counter, $button_3d_styles );
			}
			
			if( $hover_styles ) {
				$styles .= sprintf( '#wrapper .fusion-button.button-%s:hover,.fusion-button.button-%s:focus,.fusion-button.button-%s:active{%s}', $this->button_counter, $this->button_counter, $this->button_counter, $hover_styles );
			}				
			...
			if( $gradient_colors ) {
				...
				$styles .= sprintf( '#wrapper .fusion-button.button-%s{%s}', $this->button_counter, $gradient_styles );				
			}
			...
			if( $gradient_hover_colors ) {
				...
				$styles .= sprintf( '#wrapper .fusion-button.button-%s:hover,.button-%s:focus,.fusion-button.button-%s:active{%s}', $this->button_counter, $this->button_counter, $this->button_counter, $gradient_hover_styles );
			}			
