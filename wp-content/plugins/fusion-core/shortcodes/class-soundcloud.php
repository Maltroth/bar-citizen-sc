...
class FusionSC_Soundcloud {
	...
	function render( $args, $content = '' ) {
		...
		$html = sprintf( '<div %s><iframe scrolling="no" frameborder="no" style="width: %s; height: %s;" src="https://w.soundcloud.com/player/?url=%s&amp;show_comments=%s&amp;auto_play=%s&amp;color=%s"></iframe></div>',
