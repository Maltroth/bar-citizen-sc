...
class FusionSC_FourFifth {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'four-fifth-shortcode' ), FusionCore_Plugin::attributes( 'four-fifth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-four-fifth fusion-layout-column fusion-column';
