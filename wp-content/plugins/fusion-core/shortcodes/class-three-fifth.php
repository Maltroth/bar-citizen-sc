...
class FusionSC_ThreeFifth {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'three-fifth-shortcode' ), FusionCore_Plugin::attributes( 'three-fifth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-three-fifth fusion-layout-column fusion-column';
