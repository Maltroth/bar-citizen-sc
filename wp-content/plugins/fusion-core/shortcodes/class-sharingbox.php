	...
	function icon_attr( $args ) {
		...
		switch( $args['social_network'] ) {
			case 'facebook':
				...
				break;
			case 'twitter':
				$soical_link = 'https://twitter.com/share?text=' . rawurlencode( $title ) . '&url=' . $link;
				break;
			case 'linkedin':
			...
			case 'reddit':
				...
				break;
			case 'tumblr':
				$soical_link = 'http://www.tumblr.com/share/link?url='.rawurlencode($link).'&amp;name='.rawurlencode($title).'&amp;description='.rawurlencode($description);
				break;
			case 'googleplus':
				...
				break;
			case 'pinterest':
				$soical_link = 'http://pinterest.com/pin/create/button/?url='.rawurlencode( $link ).'&amp;description='.rawurlencode( $description ).'&amp;media='.$image;
				break;
			case 'vk':
				$soical_link = sprintf( 'http://vkontakte.ru/share.php?url=%s&amp;title=%s&amp;description=%s', rawurlencode( $link ), rawurlencode( $title ), rawurlencode( $description ) );
				break;			
			case 'mail':
				$soical_link = sprintf( 'mailto:?subject=%s&amp;body=%s', rawurlencode( $title ), rawurlencode( $link ) );
				break;
		}
