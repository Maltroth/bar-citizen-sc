...
class FusionSC_ContentBoxes {
	...
	function render_parent( $args, $content = '') {
		...
		if( ( self::$parent_args['layout'] == 'none' || self::$parent_args['layout'] == 'icon-on-side' || self::$parent_args['layout'] == 'icon-with-title' ) && self::$parent_args['icon_circle_size'] == '' ) {
			self::$parent_args['icon_circle_size'] = 'small';
		} elseif( self::$parent_args['icon_circle_size'] == '' ) {
			self::$parent_args['icon_circle_size'] = 'large';
		}
	...
	function heading_wrapper_attr() {
		...
		if( self::$parent_args['icon_circle_size'] ) {
			$attr['class'] .= ' icon-'.self::$parent_args['icon_circle_size'];
		}
	...
	function icon_attr() {
		...
		if( self::$child_args['image'] ) {
			...
			if( self::$parent_args['icon_circle_size'] ) {
				$attr['class'] .= ' '.self::$parent_args['icon_circle_size'];
			}
