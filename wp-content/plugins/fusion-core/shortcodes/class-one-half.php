...
class FusionSC_OneHalf {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'one-half-shortcode' ), FusionCore_Plugin::attributes( 'one-half-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-one-half one_half fusion-layout-column fusion-column';
