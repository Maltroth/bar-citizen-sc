...
class FusionSC_OneSixth {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'one-sixth-shortcode' ), FusionCore_Plugin::attributes( 'one-sixth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-one-sixth fusion-layout-column fusion-column';
