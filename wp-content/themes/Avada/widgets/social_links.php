...
class Social_Links_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		if( isset ( $instance['boxed_icon'] ) && $instance['boxed_icon'] == 'Yes' ) {
		...
		<div class="fusion-social-networks<?php echo $add_class; ?>">
			...
			foreach( $social_networks as $name => $value ):
				...
				if( strtolower( $instance['tooltip_pos'] ) != 'none' ) {
					?>
					<a class="fusion-social-network-icon fusion-tooltip fusion-<?php echo $value; ?> fusionicon-<?php echo $value; ?>" href="<?php echo $instance[$name]; ?>" data-placement="<?php echo strtolower( $instance['tooltip_pos'] ); ?>" data-title="<?php echo ucwords( $tooltip ); ?>" data-toggle="tooltip" data-original-title="" title="<?php echo ucwords( $tooltip ); ?>" <?php echo $nofollow; ?> target="<?php echo $instance['linktarget']; ?>" style="<?php echo $style; ?>"></a>
					<?php				
				} else {
				?>
				<a class="fusion-social-network-icon fusion-tooltip fusion-<?php echo $value; ?> fusionicon-<?php echo $value; ?>" href="<?php echo $instance[$name]; ?>" title="<?php echo ucwords( $tooltip ); ?>" <?php echo $nofollow; ?> target="<?php echo $instance['linktarget']; ?>" style="<?php echo $style; ?>"></a>
				<?php
				}
				endif;
			endforeach;
