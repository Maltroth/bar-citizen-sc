...
boxed_style_selector_change = function(current) {
	if(current == 'Boxed') {
		var html = 'body{background-color:#d7d6d6;background-image:url("http://isharis.dnsalias.com/wp-content/themes/Avada/images/patterns/pattern1.png");background-repeat:repeat;}#wrapper{background:#fff;max-width:1200px;margin:0 auto;}';
		
		if( jQuery( '#sliders-container .tfs-slider' ).data( 'parallax' ) == 1 ) {
			html = html + '#sliders-container .tfs-slider{display:block !important; left:50% !important; margin-left:-600px !important; margin-right: auto !important; width: 1200px !important; }';
			html = html + '.header-wrapper{margin:0 !important; }.header-v1{width:1200px !important;}';
		} else {
		    html = html + '#header-sticky{width:1200px !important; margin: 0 auto !important; left: 0 !important; right: 0 !important;}';
		}
...
<div id="style_selector" style="right: -279px;">
	...
	<div id="style_selector_container">
		...
		<div class="ss-content clearfix">
			...
			<p style="margin-bottom: -10px;"><a href="http://theme-fusion.com/avadadark">View Current Dark Demo</a></p>
		</div>
