<ul class="pyre_metabox_tabs">
	<li class="active"><a href="page"><?php _e('Product', 'Avada'); ?></a></li>
	...
	<li><a href="sliders"><?php _e('Sliders', 'Avada'); ?></a></li>	
...
<div class="pyre_metabox">
	...
	<div class="pyre_metabox_tab" id="pyre_tab_background">
		...
		$this->text(	'page_bg_color',
						...
						'Controls the background color for the outer background.'
					);
		?>
		<?php
		...
		$this->text(	'wide_page_bg_color',
						'Background Color (Hex Code)',
						'Controls the background color for the main content area.'
					);
		?>
		<?php
